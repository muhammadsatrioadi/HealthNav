...
class UserController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        // Get active hospitals for display
        $hospitals = Hospital::active()->withCount('mcuRegistrations')->orderBy('name')->get();
    ...
    public function mcuHistory(Request $request)
    {
        ...
        $mcuHistory = $query->orderBy('appointment_date', 'desc')->paginate(10);

        $hospitals = Hospital::orderBy('name')->get(); // Fetch hospitals for the filter dropdown
